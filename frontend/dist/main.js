...
const balance_1 = __webpack_require__(/*! ./balance */ "./src/components/balance.ts");
class Addmoney {
    constructor() {
        this.categoryInput = document.getElementById('categoryName');
        this.sendBtn = document.getElementById('send');
        balance_1.Balance.sending();
...
class Balance {
            ...
            if (sendBalance) {
                sendBalance.onclick = function () {
                    if (balanceInput) {
                        ...
                        custom_http_1.CustomHttp.request(config_1.default.host + '/balance', "PUT", {
    ...
    myBalance() {
        return __awaiter(this, void 0, void 0, function* () {
            let getBalance = yield custom_http_1.CustomHttp.request(config_1.default.host + '/balance');
            if (getBalance) {
                if (this.balanceCoin) {
...
/***/ "./src/components/changeOperation.ts":
/*!*******************************************!*\
  !*** ./src/components/changeOperation.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
class ChangeOperation {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                result.forEach(item => {
                    ...
                    if (this.typeField) {
                        let indexSelected = this.typeField.selectedIndex, options = this.typeField.querySelectorAll('option')[indexSelected];
                ...
                result.forEach((itemExp) => {
                    ...
                    if (this.typeField) {
                        let indexSelected = this.typeField.selectedIndex, option = this.typeField.querySelectorAll('option')[indexSelected];
    ...
    addInputNameOperations() {
        ...
        if (this.sumField) {
            this.sumField.value = this.amount;
        }
        if (this.dateField) {
            ...
            if (this.saveBtn) {
                this.saveBtn.onclick = function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        that.changeBalance();
                        try {
                            const result = yield custom_http_1.CustomHttp.request(config_1.default.host + '/operations/' + operationId, "PUT", {
    ...
    changeBalance() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let nowBalance = Number(this.balance);
            if (money) {
            ...
            let putBalance = yield custom_http_1.CustomHttp.request(config_1.default.host + '/balance', "PUT", {
...
exports.Changepay = Changepay;


/***/ }),

/***/ "./src/components/consumption.ts":
/*!***************************************!*\
  !*** ./src/components/consumption.ts ***!
  \***************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
class Consumption {
    ...
    showConsumptionElements(result) {
        ...
        const editBtnElements = document.querySelectorAll('.change');
        editBtnElements.forEach(item => {
            if (item) {
                item.onclick = function () {
                    var _a, _b, _c, _d;
                    const result = (_a = item.previousElementSibling) === null || _a === void 0 ? void 0 : _a.textContent;
                    const resultId = (_d = (_c = (_b = item.parentElement) === null || _b === void 0 ? void 0 : _b.parentElement) === null || _c === void 0 ? void 0 : _c.parentElement) === null || _d === void 0 ? void 0 : _d.id;
                    localStorage.setItem('BlockName', JSON.stringify(result));
                    localStorage.setItem('BlockId', JSON.stringify(resultId));
                };
            }
        });
        const deleteBtnElement = document.querySelectorAll('.deleted');
        const popupDeleteCategory = document.getElementById('btn-delete');
                ...
                if (item) {
                    if (popupDeleteCategory) {
                        popupDeleteCategory.onclick = function () {
                            var _a, _b, _c;
                            return __awaiter(this, void 0, void 0, function* () {
                                let resultId = (_c = (_b = (_a = item.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.parentElement) === null || _c === void 0 ? void 0 : _c.id;
                                try {
                                    const result = yield custom_http_1.CustomHttp.request(config_1.default.host + '/categories/expense/' + resultId, "DELETE");
                                    if (result) {
...
class Create {
            ...
            this.saveNewCreateOperation.onclick = function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (that.newCreateTypeOperation && that.newCreateAmountOperation
                        ...
                        try {
                            const result = yield custom_http_1.CustomHttp.request(config_1.default.host + '/operations', "POST", {
    ...
    changeBalance() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield custom_http_1.CustomHttp.request(config_1.default.host + '/balance', "PUT", {
                newBalance: this.balanceToChange
            });
        });
    }
    ...
    processForm() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.validateForm()) {
                ...
                if (this.page === 'signup') {
                    const passwordRepeat = (_f = (_e = this.fields.find(item => item.name === 'passwordRepeat')) === null || _e === void 0 ? void 0 : _e.element) === null || _f === void 0 ? void 0 : _f.value;
                    try {
                    ...
                    if (popupDeleteCategory) {
                        popupDeleteCategory.onclick = function () {
                            ...
                            return __awaiter(this, void 0, void 0, function* () {
                                let resultId = (_c = (_b = (_a = item.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.parentElement) === null || _c === void 0 ? void 0 : _c.id;
                                try {
                                    const result = yield custom_http_1.CustomHttp.request(config_1.default.host + '/categories/income/' + resultId, "DELETE");
                                    if (result) {
...
const config_1 = __importDefault(__webpack_require__(/*! ../../config/config */ "./config/config.ts"));
const auth_1 = __webpack_require__(/*! ../services/auth */ "./src/services/auth.ts");
const bootstrap = __importStar(__webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js"));
const balance_1 = __webpack_require__(/*! ./balance */ "./src/components/balance.ts");
class MainPage {
    // private from: string[];
    // private to: string[];
    constructor() {
        ...
        url_manager_1.UrlManager.getQueryParams();
        (() => {
    ...
    buildGraph(result) {
        ...
        if (this.incomeChart) {
            this.incomeChartView = new auto_1.default(this.incomeChart, {
                type: 'pie',
        ...
        if (this.expensesChart) {
            this.expensesChartView = new auto_1.default(this.expensesChart, {
                type: 'pie',
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function getOperation(period) {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        const result = yield custom_http_1.CustomHttp.request(config_1.default.host + '/operations/?period=' + period);
                        if (result) {
...
class Operations {
    ...
    getBalance() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let balance = yield custom_http_1.CustomHttp.request(config_1.default.host + '/balance');
                if (balance) {
        ...
        result.forEach((item) => {
            ...
            if (this.buttons) {
                ...
                if (item) {
                    ...
                    let res;
                    let str = (_a = item === null || item === void 0 ? void 0 : item.date) === null || _a === void 0 ? void 0 : _a.toString();
                    let arr = str === null || str === void 0 ? void 0 : str.split('-');
                    if (arr) {
                        ...
                        item.onclick = function () {
                            if (that.popupDeleteOperation) {
                                that.popupDeleteOperation.onclick = function () {
                                    var _a, _b;
                                    let resultId = (_b = (_a = item === null || item === void 0 ? void 0 : item.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.id;
                                    if (resultId) {
                                        try {
...
const mainPage_1 = __webpack_require__(/*! ./components/mainPage */ "./src/components/mainPage.ts");
const operations_1 = __webpack_require__(/*! ./components/operations */ "./src/components/operations.ts");
const auth_1 = __webpack_require__(/*! ./services/auth */ "./src/services/auth.ts");
const consumption_1 = __webpack_require__(/*! ./components/consumption */ "./src/components/consumption.ts");
const create_1 = __webpack_require__(/*! ./components/create */ "./src/components/create.ts");
const changeOperation_1 = __webpack_require__(/*! ./components/changeOperation */ "./src/components/changeOperation.ts");
const addmoney_1 = __webpack_require__(/*! ./components/addmoney */ "./src/components/addmoney.ts");
const changemoney_1 = __webpack_require__(/*! ./components/changemoney */ "./src/components/changemoney.ts");
const changepay_1 = __webpack_require__(/*! ./components/changepay */ "./src/components/changepay.ts");
const addpay_1 = __webpack_require__(/*! ./components/addpay */ "./src/components/addpay.ts");
const income_1 = __webpack_require__(/*! ./components/income */ "./src/components/income.ts");
class Router {
    constructor() {
        this.layout = document.getElementById('layout');
        this.sidebar = document.getElementById('sidebar');
        ...
        this.routs = [
            ...
            },
            {
                ...
                load: () => {
                    new changeOperation_1.ChangeOperation();
                }
            },
            {
                route: '#/addmoney',
...
const config_1 = __importDefault(__webpack_require__(/*! ../../config/config */ "./config/config.ts"));
class Auth {
    static processUnauthorisedResponse() {
        return __awaiter(this, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.status < 200 || response.status >= 300) {
                if (response.status === 401) {
                    const result = yield auth_1.Auth.processUnauthorisedResponse();
                    if (result) {
